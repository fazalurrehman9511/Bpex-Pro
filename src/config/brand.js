...
/** Square BPX mark — website header, footer, favicon, PWA */
...
/** Same mark as bpexch.xyz /Users/Login embed */
export const BPEXCH_LOGIN_LOGO = '/bpexch-login-logo.jpg'
/** Circular BP mark — Capacitor APK only (login + in-app chrome) */
export const NATIVE_APP_LOGO = '/bp-circle-icon.png'
