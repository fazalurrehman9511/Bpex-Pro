...
export const SOCIAL_PLATFORMS = [
  ...
  { id: 'x', label: 'X (Twitter)', placeholder: 'https://x.com/yourpage' },
  ...
  { id: 'tiktok', label: 'TikTok', placeholder: 'https://tiktok.com/@yourpage' },
]

export function getActiveSocialLinks(social) {
  const links = asObject(social, {})
  return SOCIAL_PLATFORMS.map((platform) => ({
    ...platform,
    url: normalizeSocialUrl(links[platform.id]),
