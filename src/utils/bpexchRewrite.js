...
(function(){
  ...
  function fix(u){
    ...
    if(u.indexOf('/api/bpexch/')===0||u.indexOf('/api/transactions')===0||u.indexOf('/api/admin')===0||u.indexOf('/api/blog')===0||u.indexOf('/api/live-events')===0||u.indexOf('/api/payment-accounts')===0||u.indexOf('/api/withdraw-methods')===0||u.indexOf('/api/homepage-content')===0||u.indexOf('/api/brand-guide-content')===0||u.indexOf('/api/responsible-gaming-content')===0||u.indexOf('/api/support-contact')===0||u.indexOf('/api/contact')===0||u.indexOf('/api/register')===0||u.indexOf('/api/whatsapp-agents')===0||u.indexOf('/api/health')===0||u.indexOf('/uploads/')===0)return u;
